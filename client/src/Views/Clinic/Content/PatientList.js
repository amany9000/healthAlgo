...
export default function PatientList() {
    ...
    const [patientData, setPatientData] = useState({
        firstName: '', lastName: '', bloodtype: '', height: '', BMI: '', email: '', password: '', confirmPassword: '', role: 'Pasien'
    });
    ...
    const savePatient = () => {
        const { firstName, lastName, bloodtype, height, BMI, email, password, confirmPassword } = patientData;

        dispatch(createPatient(firstName, lastName, bloodtype, height, BMI, email, password, confirmPassword))
            .then(data => {
                setPatientData({
                    id: data.id,
    ...
    const clear = () => {
        setPatientData({ firstName: '', lastName: '', bloodtype: '', height: '', BMI: '', email: '', password: '', confirmPassword: '', role: 'Pasien' });
    }
                            ...
                            <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                                ...
                                <DialogContent>
                                    ...
                                    <TextField
                                        ...
                                        type="number"
                                        fullWidth
                                        value={patientData.BMI} onChange={(e) => setPatientData({...patientData, BMI: e.target.value })}
                                    />
                                    <TextField
                                        disabled={editMode === true ? true : false}
                                        hidden={editMode === true ? true : false}
